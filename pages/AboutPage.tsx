      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            {/* BIO */}
            <motion.div variants={fadeLeft} className="text-gray-300 leading-relaxed text-[15px]">
              I’m <span className="text-white font-semibold">Md. Abdur Rahman</span>,
              a passionate full stack developer from Bangladesh. I started my
              journey in 2025 and continuously improving my skills.
            </motion.div>

            {/* HIGHLIGHTS */}
            <motion.div variants={container} className="space-y-5 text-sm text-gray-400">
