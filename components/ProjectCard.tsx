        ...
        <div className="flex gap-3 pt-1">
          {project.github && (
            <a
              ...
              className="flex items-center gap-2 text-sm px-3 py-2 rounded-lg border border-white/10 text-white hover:bg-white/10 transition"
            >
              <Github />
              Code
            </a>
          ...
          {project.live && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-sm px-3 py-2 rounded-lg bg-emerald-500 text-black font-medium hover:bg-emerald-600 transition"
            >
